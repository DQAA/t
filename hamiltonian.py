...
from TB.diatomic_matrix_element import me, me_diatomic
        ...
        if atom1 != atom2 or coords is not None:
            ...
            if self.radial_dependence is None:
                ...
                if s1 == s2:
                    ...
                    param = me_diatomic(atoms, code, l_min, l_max, 0, which_neighbour, overlap=overlap, bl=True)
                    # print("##########################################")
